...
export default function HeroSection() {
  return (
    <>
      <div
        className={`relative flex min-h-screen w-screen items-center bg-[url(/hero-background.jpg)] bg-cover bg-center bg-no-repeat`}
      >
        <div className='fixed inset-0 min-h-screen bg-black opacity-70'></div>
